    ...
    public function new () : Void {
        ...
        this.body = Util.elm(
            ...
            },
            {
                ...
                h.set( 'background', 'url(' + BGDATA[this.scale] + ') left top no-repeat' );
                h;
            }
        );
